...
- obj:
  ...
  An object returned by function select_mmlca

## Value

A `ggplot2` object containing an alluvial plot that visualizes
...
computed and converted to modal class assignments. The resulting
classifications are displayed as an alluvial diagram using ggalluvial.
