...
get_internal_validation_matrix <- function(fit, X) {
  ...
  Qmatrix
=======
#' Function to calculate the approximate classification matrix
#'
#' @param fit object of class poLCA.
#' @param X matrix with chronic diseases variabiables (coded as 1:no and 2:yes) to use for the calculation.
#'
#' @return nc x nc matrix where nc is the number of latent multimorbidity patterns.
#' @export
#'
#' @examples
get_internal_validation_matrix <- function(fit,X){
...
>>>>>>> 913c431363112a33f6b9a5f53db8d024bd9780f9
}
